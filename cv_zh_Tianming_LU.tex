...
\section{工作背景}
\cventry{2020/11 -- 至今}{架构师}{深信服创新研究院}{深圳}{}{%
\begin{itemize}%
\item 负责AI平台的项目演进、规划和架构设计
  \begin{itemize}%
  \item 设计实现基于Spark Streaming的实时威胁捕猎告警系统
  \item 基于Spark，Kubeflow等技术构建AI平台。优化AI平台预处理、模型训练和部署逻辑，提升整体平台灵活性和易用性
  \item 预研图计算、边缘推理框架等相关技术，设计实现兼容异构硬件的通用推理平台
  \end{itemize}
\end{itemize}}
\cventry{2020/06 -- 2020/10}{资深研发工程师}{SmartNews}{上海}{}{%
\begin{itemize}%
\item 设计实现基于Flink的实时处理平台，为公司业务的实时化迁移提供平台基础
  \begin{itemize}%
  \item 设计实现Flink任务的统一提交、管控。提供可视化、多租户等功能，降低流处理任务的迁移门槛
  \item 负责实时平台与亚马逊AWS、Datadog、Slack等第三方服务的整合工作
  \end{itemize}
\end{itemize}}
...
\cvlistdoubleitem{工具：Idea, Git, Linux}{机器学习：Spark MLlib, TensorRT}
