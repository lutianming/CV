...
\address{世纪广场2幢1单元601室}{江苏 太仓}{215400}             % 可选项、如不需要可删除本行
\mobile{180 0622 0697}                         % 可选项、如不需要可删除本行
\email{lutianming1005@hotmail.com}                    % 可选项、如不需要可删除本行
...
\section{教育背景}
\cventry{2013--2015}{Diplôme d'ingénieur(硕士)}{Computer Science}{Telecom ParisTech}{法国}{}
