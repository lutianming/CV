...
\photo[64pt][0.4pt]{usa_visa.jpg}                  % '64pt' is the height the picture must be resized to, 0.4pt is the thickness of the frame around it (put it to 0pt for no frame) and 'picture' is the name of the picture file; optional, remove the line if not wanted
...
\section{Experience}
\cventry{2019/01 -- Now}{Manager}{Transwarp}{Shanghai}{}{%
\begin{itemize}%
...
\cventry{2015/09 -- 2018/12}{Development Engineer}{Transwarp}{Shanghai}{}{%
\begin{itemize}%
...
\section{Skills}
\cvitem{Programming}{Scala, Java, Python, C/C++}
\cvitem{Big Data}{Spark, Hadoop}
\cvitem{Backend}{Spring, Redis, MySQL}
\cvitem{Cloud}{Docker, Kubernetes}
\cvitem{Tools}{Idea, Git, Linux}
