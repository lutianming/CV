...
\address{birthday: 05 Oct 1990}{}{Jiangsu Taicang}    % optional, remove the line if not wanted
...
\section{Experience}
\cventry{2019/03 -- Now}{Development Manager}{Transwarp}{Shanghai}{}{%
\begin{itemize}%
\item Responsible for the design, development of Transwarp machine learning platform and the management of developing process
  \begin{itemize}%
  \item Design and implement micro-service architecture
  \item Build business solution from machine learning platform
  \end{itemize}
\end{itemize}}
...
\item Responsible for the design and development of Transwarp machine learning platform
  ...
  \item Enhance Livy to build a multi-user and multi-task Spark environment
  \item Integrate Spark with Tensorflow
  \item Improve model performance after deployment
...
\section{Skills}
\cvlistdoubleitem{Programming: Scala, Java, Python}{Big Data: Spark, Kafka, HDFS, Hadoop}
