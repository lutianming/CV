...
\address{Telecom ParisTech}{75013 Paris}    % optional, remove the line if not wanted
\mobile{07 51 33 84 51}                     % optional, remove the line if not wanted
...
\section{Education}
\cventry{2013--}{Engineer Degree}{}{Telecom ParisTech}{}{}
\cventry{2009--2012}{Bachelor}{Software Engineering}{Nanjing
  University}{\textit{Rank: top 10\%}}{}  % arguments 3 to 6 can be left empty
...
\cvdoubleitem{Java}{2 years}{C/C++}{3 years}
\cvdoubleitem{Python}{3 year}{}{}
...
\item build a job query tool for the FRS(Finance Reporting System) group:
  ...
  \item help rerun jobs when specific jobs fail;
  \end{itemize}
\end{itemize}}

\section{Projects}
\cventry{2011/7-2011/8}{Ipay mobile payment system}{}{}{}{quick payment with
  barcode from mobile camera\newline{}my work: data parsing}
\cventry{2011/11-2012/3}{Kinect Classroom}{a project in the seminar of Image and Video Analysis with Depth Information}{}{}{use Kinect to help teachers\newline{}I implemented the gesture recognition part}
...
\cvitem{machine learning}{implement a simple gesture recognizer based upon
  Kinect; take part in online ml-class}
\cvitem{swimming}{}
\cvitem{comic}{}
